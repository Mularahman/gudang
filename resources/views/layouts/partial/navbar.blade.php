<nav id="header" class="bg-gray-900 fixed w-full z-10 top-0 shadow">
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
        ...
        <div class="w-1/2 pl-2 md:pl-4">
            <a class="text-gray-100 text-base xl:text-xl no-underline hover:no-underline font-bold" href="{{route ('home')}}">
                <i class="fas fa-moon text-blue-400 pr-3"></i> Admin Gudang
            </a>
        </div>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-gray-900 z-20"
            id="nav-content">
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-4">
                <li class="mr-6 my-2 md:my-0">
                 ...
                 {{--  <li class="mr-6 my-2 md:my-0">
                    <a href="#"
                        ...
                        <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Kategori</span>
                    </a>
                </li>  --}}
                {{-- <li class="mr-6 my-2 md:my-0">
                    <a href="#"
            ...
            <div class="relative pull-right pl-4 pr-4 md:pr-4">
